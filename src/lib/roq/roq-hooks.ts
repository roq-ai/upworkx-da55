...
export function useBidFindMany<
  T extends Prisma.bidFindManyArgs,
  R extends GetFindResult<Prisma.$bidPayload<DefaultArgs>, T>[],
>(args?: Prisma.SelectSubset<T, Prisma.bidFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useBidFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.bid.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useBidCount<T extends Prisma.bidCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.bidCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useBidCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.bid.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useBidFindManyWithCount<
  T extends Prisma.bidFindManyArgs,
  R extends { data: GetFindResult<Prisma.$bidPayload<DefaultArgs>, T>[]; count: number },
>(args?: Prisma.SelectSubset<T, Prisma.bidFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useBidFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.bid.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useBidFindFirst<
  T extends Prisma.bidFindFirstArgs,
  R extends GetFindResult<Prisma.$bidPayload<DefaultArgs>, T>,
>(args?: Prisma.SelectSubset<T, Prisma.bidFindFirstArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useBidFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.bid.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,

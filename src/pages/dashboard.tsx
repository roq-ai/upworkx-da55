...
import { useProjectCount, useBidCount, useFreelancerCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const bidStat = useBidCount();

  const freelancerStat = useFreelancerCount();

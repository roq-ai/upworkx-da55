...
import { useBidFindFirst, useRoqClient } from 'lib/roq';
...
function BidViewPage() {
  ...
  const queryParams = useMemo<{ include: { freelancer: boolean; project: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useBidFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem
                  ...
                  text={data?.proposed_completion_date ? format(data?.proposed_completion_date, 'dd-MM-yyyy') : ''}
                />
